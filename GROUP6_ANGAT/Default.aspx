...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="hero">
        ...
        <div class="hero-inner">
            ...
            <div class="hero-btns">
                <a href="HanapTrabaho.aspx" class="btn-primary">🔍 Maghanap ng Trabaho</a>
                <a href="HanapGawa.aspx" class="btn-secondary">🛠️ Mag-alok ng Serbisyo</a>
                <a href="HanapGawa.aspx" class="btn-secondary">🛠️ Mag-alok ng Serbisyo</a>
            </div>
        </div>
        <div class="wave">
    ...
    <div class="section section-white">
        ...
        <div class="category-grid">
            <a href="HanapTrabaho.aspx" class="cat-card">
            ...
            <a href="HanapGawa.aspx" class="cat-card">
            ...
            <a href="Directory.aspx" class="cat-card">
    ...
    <div class="section section-light">
        ...
        <div class="listings-grid">
            <a href="HanapTrabaho.aspx" class="listing-card">
        ...
        <div style="text-align:center;">
            <a href="HanapTrabaho.aspx" class="btn-green">Tingnan Lahat ng Trabaho →</a>
        </div>
    </div>
